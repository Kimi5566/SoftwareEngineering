...
class Video_controller(object):
    ...
    def __get_next_frame(self):
        ...
        self.ui.lbl_frame.setText(
            f"frame number: {self.current_frame_no}/{self.video_total_frame_count}")
        return frame
